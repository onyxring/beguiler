> **Note:* This is the first project I've run where I've coordinated with AI.  It feels strange, and will take some getting use to, so I want to be clear: I created this document solely by myself.  As such, it likely contains typos, fuzzy wording, and all the things which sneak into documents written by humans like me.  If you'd prefer a document generated by AI, consider the "Beguile Language Specification" document, which was originally authored by an LLM (though still edited by me).*
