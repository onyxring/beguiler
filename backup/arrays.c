...
extern void make_global()
{
    ...
    if (AO.marker != 0) backpatch_zmachine(AO.marker, GLOBALVAR_ZA, 4*globalnum);
    ...
    */
    ...
    switch(data_type)
    {
        case NULLS_AI:
            ...
            //JimF: What is this? its formatted like it should be prefixed by an if statement, but there isn't one.
...
{   dynamic_array_area = NULL;
    ...
    variables = NULL;
        ...
        /* These are not used in Glulx. */ //Jim
