...
/*                                                                           */
/*   For notes on how this program may legally be used, see the Designers   */
...
/*                                                                           */
/*   PROMPT_INPUT        - prompt input (dont use Unix-style command line)  */
/*   TIME_UNAVAILABLE    - dont use ANSI time routines to work out todays  */
/*                         date                                              */
...
/*                                                                           */
/*   Its assumed that the host OS has the concept of subdirectories and     */
...
/*   (for game files), etc., to indicate the files type (and, crucially,    */
...
/*   them unless theres a good reason why not.)                             */
/*                                                                           */
...
/*   story files).                                                           */
/*                                                                           */
/*   If its convenient for your port you can alter the detailed definitions */
...
/* ------------------------------------------------------------------------- */
/*   A large block of #defined constant values follows.                     */
/* ------------------------------------------------------------------------- */
...
/* Glulx-only constraints */
#define  VENEER_CONSTRAINT_ON_CLASSES  (VENEER_CONSTRAINT_ON_CLASSES_G)
#define  VENEER_CONSTRAINT_ON_IP_TABLE_SIZE  (VENEER_CONSTRAINT_ON_IP_TABLE_SIZE_G)
...
/* In Glulx, thats the range -0x8000 to 0x7fff instead. */
