...
/* Grab the Glulx part of a platformval (numeric only) - Glulx-only build. */
#define SELECTVAL(i) (alloptions[i].val.g)
...
/* Display all the options (for $LIST)
*/
...
/* Apply the options to our compiler variables. 
*/
